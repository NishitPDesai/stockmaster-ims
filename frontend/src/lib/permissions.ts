...
export function canDelete(user: User | null, entity: 'product' | 'operation' | 'warehouse' | 'location'): boolean {
  return hasPermission(user, `${entity}s.delete` as Permission)
}

export function canEdit(user: User | null, entity: 'product' | 'operation' | 'warehouse' | 'location'): boolean {
